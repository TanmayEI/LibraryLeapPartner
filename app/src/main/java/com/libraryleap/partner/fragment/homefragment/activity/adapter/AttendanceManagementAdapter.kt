...
) : RecyclerView.Adapter<AttendanceManagementAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: AttendanceManagementViewBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            AttendanceManagementViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
