...
import com.libraryleap.partner.databinding.EnquiryManagementViewBinding
...
class EnquiryManagementAdapter  (
    var homedetailslist: List<TodayEnquiryViewModel>,
    val mContext: Context,
) : RecyclerView.Adapter<EnquiryManagementAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: EnquiryManagementViewBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            EnquiryManagementViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
