...
class TodayEnquiryAdapter  (
    var homedetailslist: List<TodayEnquiryViewModel>,
    val mContext: Context,
) : RecyclerView.Adapter<TodayEnquiryAdapter.ViewHolder>() {

    inner class ViewHolder(val binding: TodayEnquiryViewBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            TodayEnquiryViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
